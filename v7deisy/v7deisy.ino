//para tiempo = 30:00
//verde de 0 a 15 min
//amarillo de 15:01 a 20 min
//rojo de 20:01 a  30 min
...
void setup() 
{
  ...
  delay (1000);  
   ...
   for(dec_m=0;dec_m<3;dec_m++)
   {
   for(uni_m=0;uni_m<=9;uni_m++)
    {
    ...
    if(dec_m==3)
            {
            digitalWrite (2,LOW);  
            digitalWrite (3,LOW);   //TODO apagado          
            digitalWrite (4,LOW); //
            }
   uni_m=0;
   mostrar_um();
